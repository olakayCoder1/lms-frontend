...
import Logo from '../../images/logo/unilorin-3.png';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#00044b] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={`${Logo}`} className=' max-h-32' alt="Logo" />
          {/* <img src='https://schooltry-tertiary-2.s3.eu-west-1.amazonaws.com/institutionLogos/Unilorin_6500995e76d79.jpeg' className=' max-h-32' alt="Logo" /> */}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {authUser?.role === 'admin' && (
                <>
                  ...
                  <SidebarLinkGroup
                  activeCondition={
                    pathname === '/course-management' || pathname.includes('course-management')
                  }
                >
                  {(handleClick, open) => {
                    return (
                  ...
                  <SidebarLinkGroup
                  activeCondition={
                    pathname === '/lecturers' || pathname.includes('lecturers')
                  }
                >
                  {(handleClick, open) => {
                    return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/content-management' || pathname.includes('content-management')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/material-management' || pathname.includes('material-management')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/quiz-management' || pathname.includes('quiz-management')
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/quiz-management' ||
                            pathname.includes('quiz-management')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
              ...
              <li>
              <button 
                onClick={deleteUserFromLocalStorage}
                className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out text-red-700 hover:text-red-500 lg:text-base">
                <svg
                  className="fill-current"
                  width="22"
                  height="22"
